...
void s_rotl(stack_t **head, unsigned int line_num);
void s_rotr(stack_t **head, __attribute__((unused)) unsigned int line_num);
void addnode(stack_t **head, int n);
void addqueue(stack_t **head, int n);
void s_queue(stack_t **head, unsigned int line_num);
void s_stack(stack_t **head, unsigned int line_num);
#endif
